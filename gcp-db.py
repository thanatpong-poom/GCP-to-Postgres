...
# projects_list = [('CPProduction/Farm_DataV_CPProduct', 'test_production'),('ImportProduct/Farm_DataV_ImportProduct','test_importproduct'),('Industry/Farm_DataV_Industry','test_industry'),('Ingredient/Farm_DataV_Ingredient','test_ingredient')]
# bucket_name = 'spld-foodsecurity'

# try:spld-foodsecurity/CPProduction
